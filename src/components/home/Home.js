...
const Home = ({ nav }) => {
    ...
    return (
        <main className='w-full h-screen flex p-2   card relative'>
            <Filters nav={nav} />
            <section className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4  w-[100%] justify-evenly mx-auto overflow-y-scroll card'>
